...
<title>IN CLASS ASSIGNMENT</title>
 ...
 ?> 
<body>
    "The memory of that scene for me like a frame of film forever at that moment: The <?php echo $color[2];?> red carpet, the <?php echo $color[1];?> green lawn, the <?php echo $color[0];?> white house, the leaden sky. The new preseident and his first lady. - Richard M. Nixon. 
